...
var _emscripten_websocket_get_ready_state = (socketId, readyState) => {
  ...
  HEAP16[SAFE_HEAP_INDEX(HEAP16, ((readyState) >> 1), "storing")] = socket.readyState;
  return 0;
};
...
var _emscripten_websocket_set_onclose_callback_on_thread = (socketId, userData, callbackFunc, thread) => {
  ...
  socket.onclose = e => {
    ...
    HEAP8[SAFE_HEAP_INDEX(HEAP8, (eventPtr) + (4), "storing")] = e.wasClean, HEAP16[SAFE_HEAP_INDEX(HEAP16, (((eventPtr) + (6)) >> 1), "storing")] = e.code, 
...
var _emscripten_websocket_set_onmessage_callback_on_thread = (socketId, userData, callbackFunc, thread) => {
  ...
  socket.onmessage = e => {
    ...
    HEAP8[SAFE_HEAP_INDEX(HEAP8, (eventPtr) + (12), "storing")] = isText, ((a1, a2, a3) => dynCall_iiii(callbackFunc, a1, a2, a3))(0, eventPtr, userData);
    _free(buf);
  };
  return 0;
};
...
var ASM_CONSTS = {
  ...
  609778: () => window.innerWidth,
  609808: () => window.innerHeight,
  609839: ($0, $1) => {
...
var _main, _malloc, _fflush, _free, ___funcs_on_exit, _emscripten_stack_get_end, _emscripten_stack_get_base, _emscripten_builtin_memalign, _sbrk, _emscripten_get_sbrk_ptr, _emscripten_stack_init, _emscripten_stack_get_free, __emscripten_stack_restore, __emscripten_stack_alloc, _emscripten_stack_get_current, dynCall_v, dynCall_viiii, dynCall_i, dynCall_vi, dynCall_iii, dynCall_vii, dynCall_ii, dynCall_viii, dynCall_iiiiii, dynCall_iiii, dynCall_iiiii, dynCall_vjii, dynCall_vf, dynCall_iiji, dynCall_iid, dynCall_di, dynCall_viiiii, dynCall_iiiiiiii, dynCall_iiiiiiiiii, dynCall_iiiiiiiiiiiiiiff, dynCall_iiiiiiiii, dynCall_viiiiiii, dynCall_viiiiiiiiiii, dynCall_iiiiiidiiff, dynCall_ji, dynCall_jiji, dynCall_vffff, dynCall_viiiiiiii, dynCall_viiiiiiiii, dynCall_vff, dynCall_vfi, dynCall_viif, dynCall_vif, dynCall_viff, dynCall_vifff, dynCall_viffff, dynCall_viiiiii, dynCall_vfff, dynCall_iidiiiii, _asyncify_start_unwind, _asyncify_stop_unwind, _asyncify_start_rewind, _asyncify_stop_rewind, memory, __indirect_function_table, wasmMemory;
